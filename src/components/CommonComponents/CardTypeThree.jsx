  ...
  return(
      <NavLink to={"/basket"} className={s.CardTypeThree}>
        <div className={s.CardTypeThree_image}>
          <img className={s.CardTypeThree_image_img} src="/images/recipe-1.png" alt="cardtypethree" />
        </div>
          ...
          <div className={s.CardTypeThree_info}>
            <p className={s.CardTypeThree_info_text}>
              ...
              <span className={s.before}>
                <img src="/images/u_clock.svg" alt="time" className={s.CardTypeThree_info_text_img}/>
              </span>
            </p>
            <p className={s.CardTypeThree_info_text}>
              137 ккал
              <span className={s.before}>
                <img src="/images/u_fire.svg" alt="fire" className={s.CardTypeThree_info_text_img}/>
              </span>
            </p>
          </div>
        </div>
